...
import (
	protobuf "github.com/buildbuddy-io/tensorflow-proto/tensorflow/core/protobuf"
...
func (x *GetModelMetadataResponse) GetMetadata() map[string]*any1.Any {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_tensorflow_serving_apis_get_model_metadata_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x42, 0x46, 0x5a, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
